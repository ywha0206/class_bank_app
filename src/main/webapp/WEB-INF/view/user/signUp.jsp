...
<div class="col-sm-8">
	...
	<form action="/user/sign-up" method="post" enctype="multipart/form-data">
		...
		<div>
			<a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=f0fc58d7b92094ca5c09ca1d5123ef9d&redirect_uri=http://localhost:8080/user/kakao">
